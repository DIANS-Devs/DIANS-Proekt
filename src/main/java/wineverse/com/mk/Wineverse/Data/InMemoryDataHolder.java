...
public class InMemoryDataHolder {
    ...
    public void init() {
        ...
        Winery w1 = new Winery("Popova Kula","Wine Boulevard No.1 Demir Kapija","Понеделник-Петок 10:00-22:00", cityRepository.findCity("Демир Капија"),"http://www.popovakula.com.mk/", "gglmapsid",	"076 432 630",	"+389 76 432 630", (float) 41.22, (float) 22.2);
