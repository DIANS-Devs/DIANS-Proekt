...
//
//            Winery winery3 = new Winery("Винарија со слики", types2, "67, Македонска Преродба, Оризари, Ѓорче Петров, Скопје, Општина Ѓорче Петров, Град Скопје, Скопски СР, 1060", cityRepository.findByName("Свети Николе"), "071 331 114", "+389 70 331 114", "Monday - Sunday:  7:00AM–10:00PM", "Нема", OperationalStatus.OPEN, true, (float) 42.0037876, (float) 21.9278854);
//
...
//
//            Winery winery4 = new Winery("Винарија Картал", types3, "Улица 103, Кучково, Општина Ѓорче Петров, Град Скопје, Скопски СР", cityRepository.findByName("Велес"), "070 331 114", "+389 74 331 114", "Monday - Sunday:  7:00AM–10:00PM", "Нема", OperationalStatus.OPEN, true, (float) 41.7988315, (float) 21.7721987);
//
